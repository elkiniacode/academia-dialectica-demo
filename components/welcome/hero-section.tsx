...
export function HeroSection() {
  ...
  // ==========================================
  return (
    <section id="hero" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gray-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div
          className={`relative w-full aspect-square lg:aspect-auto lg:h-[600px] rounded-[2.5rem] overflow-hidden shadow-2xl shadow-blue-900/20 ring-1 ring-gray-900/5 bg-gray-900 transition-all duration-500 ease-in-out ${
